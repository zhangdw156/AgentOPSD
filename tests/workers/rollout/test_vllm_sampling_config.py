...
MODULE_PATH = REPO_ROOT / "verl/workers/rollout/vllm_config.py"
SPEC = importlib.util.spec_from_file_location("vllm_config", MODULE_PATH)
assert SPEC is not None and SPEC.loader is not None
VLLM_CONFIG = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(VLLM_CONFIG)

build_vllm_sampling_params_kwargs = VLLM_CONFIG.build_vllm_sampling_params_kwargs
resolve_vllm_engine_seed = VLLM_CONFIG.resolve_vllm_engine_seed
